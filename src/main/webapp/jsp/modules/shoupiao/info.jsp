            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">售票登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="carDriver" name="carDriver" class="form-control"
                                                   v-model="ruleForm.carDriver" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="start" name="start" class="form-control"
                                                   v-model="ruleForm.start" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="sellMoney" name="sellMoney" class="form-control"
                                                   v-model="ruleForm.sellMoney" readonly>
                                        </div>
                                ...
                                <input id="carId" name="carId" v-model="ruleForm.carId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="actualMoney" name="actualMoney" class="form-control"
                                               v-model="ruleForm.actualMoney" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>售票状态</label>
                                    <input id="shoupiaoValue" name="shoupiaoValue" class="form-control"
                                           v-model="ruleForm.shoupiaoValue" readonly>
                                </div>
        ...
        if (ruleForm.repairContent != null && ruleForm.repairContent != 'null' && ruleForm.repairContent != '') {
            ...
            var repairContentUeditor = UE.getEditor('repairContentEditor');
                repairContentUeditor.ready(function () {
                    ...
                    repairContentUeditor.setDisabled('fullscreen');
            });
        }
    }
